...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">StarTracker</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <?= Html::a('<i class="fa fa-users"></i> ' . Yii::t('app', 'Users') . '<span class="fa arrow"></span>', ['/user/index']) ?>
                        <ul class="nav nav-second-level">
                            <li><?= Html::a('<i class="fa fa-list"></i> ' . Yii::t('app', 'All users'), ['/user/index']) ?></li>
                            <li><?= Html::a('<i class="fa fa-user-plus"></i> ' . Yii::t('app', 'Create'), ['/user/create']) ?></li>
                        </ul>
                    </li>
                    <li>
